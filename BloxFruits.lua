...
task.spawn(function()
	while task.wait(.1) do
		pcall(function()
			if _G.Settings.Main["Auto Farm Level"] and BringMobFarm then
		...
		if _G.Settings.Main["Auto Farm Level"] then
			if QuestC.Visible == true then
				...
				if game:GetService("Workspace").Enemies:FindFirstChild(QuestCheck()[3]) then
							...
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat task.wait()
									if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, QuestCheck()[6]) then
										...
										v.Head.CanCollide = false
										BringMobFarm = true
										EquipWeapon(_G.Settings.Configs["CurrentWeapon"])
										v.HumanoidRootPart.Transparency = 1
					...
					UnEquipWeapon(_G.Settings.Configs["CurrentWeapon"])
...
tab1.newToggle("Auto Farm Level", "Auto Farms Enemies by your Level", _G.Settings.Main["Auto Farm Level"], function(state)
...
tab1.newToggle("Auto Haki", "", _G.Settings.Configs["Auto Haki"], function(state)
	_G.Settings.Configs["Auto Haki"] = state
end)
