...
if game.CoreGui:FindFirstChild("GhostSpyGUI") then
    game.CoreGui.GhostSpyGUI:Destroy()
end
...
local GhostSpyGUI = Instance.new("ScreenGui")
...
GhostSpyGUI.Name = "GhostSpyGUI"

Parent(GhostSpyGUI)

mainFrame.Name = "mainFrame"
mainFrame.Parent = GhostSpyGUI
...
BrowserHeader.Parent = GhostSpyGUI
...
mouse.KeyDown:Connect(function(key)
    if key:lower() == settings["Keybind"]:lower() then
        GhostSpyGUI.Enabled = not GhostSpyGUI.Enabled
    end
end)
...
HeaderTextLabel.Text = "Ghost Spy"
